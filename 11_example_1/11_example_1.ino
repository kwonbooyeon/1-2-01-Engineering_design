...
#define _DUTY_NEU 1467 // servo neutral position (90 degree)
#define _DUTY_MAX 2374 // servo full counterclockwise position (180 degree)
...
//  Serial.println((dist_raw-180)/(360-180)*((_DUTY_MAX-_DUTY_MIN)/100));
 ...
 if (dist_ema<=180){
  ...
  myservo.writeMicroseconds(_DUTY_MIN+(dist_ema-180)*(_DUTY_MAX-_DUTY_MIN)/180);
  } 
  else{
